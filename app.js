...
let answer = sum(answer1, c)[0];
let answer2 = multiply(a, b)[0];
let answer3 = multiply(answer2, c)[0];
let string2 = (a + ' and ' + b + ' and ' + c + ' sum to ' + answer + '.');
let string1 = ('The product of ' + a + ' and ' + b + ' and ' + c + ' is ' + answer3 + '.');

return[answer, answer3, string2, string1];
...
function multiplyArray(multArr) { //eslint-disable-line
  let y = multiply(testArray1[0],testArray1[1])[0];
  multArr = multiply(y, testArray1[2])[0];
  let newString = ('The numbers '+testArray1[0]+ ',' + testArray1[1]+ ',' + testArray1[2]+ ' have a product of ' +multArr+  '.');
  console.log(multArr, newString);
  return[multArr, newString]; 
}
